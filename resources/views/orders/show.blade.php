        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-xl-4">
                        ...
                        <div class="card-body">
                            ...
                            @elseif($order->user)
                                <div class="alert alert-info">
                                    <i class="bi bi-info-circle"></i> This order is linked to user account
                                </div>
                                <div class="d-flex align-items-center">
                                    <div class="avatar-lg me-3">
                                        <div class="avatar-title bg-secondary-subtle rounded-circle fs-3">
                                            {{ Str::substr($order->user->first_name ?? 'U', 0, 1) }}
                                        </div>
                                    </div>
                                    <div>
                                        <h5 class="mb-1">{{ $order->user->first_name ?? 'N/A' }} {{ $order->user->last_name ?? '' }}</h5>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0"><i class="bi bi-person-badge"></i> Sales Information</h5>
                        </div>
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <p class="mb-0 text-muted">Processed by</p>
                                    <strong>{{ $order->user ? ($order->user->first_name . ' ' . $order->user->last_name) : 'N/A' }}</strong>
                                </div>
                            </div>
                            @if($order->commission_amount)
                                ...
                                <div class="mt-2">
                                    ...
                                    <strong class="text-success">${{ number_format($order->commission_amount, 2) }} ({{ $order->commission_rate }}%)</strong>
                                </div>
                            @endif
                        </div>
                    </div>
                ...
                <div class="col-xl-8">
                            ...
                            <div>
                                ...
                                <p class="text-muted mb-0 mt-2">
                                    ...
                                    @if($order->payment_method)
                                        <span class="badge bg-info ms-1">{{ ucfirst($order->payment_method) }}</span>
                                    @endif
                                </p>
                            </div>
                            <div>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        @endif
                                                        @if($item->brand_name)
                                                            <br><small class="text-muted">Brand: {{ $item->brand_name }}</small>
                                                        @endif
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-center fw-bold">{{ number_format($item->quantity ?? 0) }}</td>
                                            <td class="text-end text-success fw-bold">${{ number_format($item->unit_price ?? 0, 2) }}</td>
                                            <td class="text-end text-success fw-bold">${{ number_format($item->total_price ?? ($item->unit_price * $item->quantity), 2) }}</td>
                                        </tr>
                                        @empty
                                        <tr>
                            ...
                            <div class="row">
                                <div class="col-md-6 offset-md-6">
                                    <table class="table table-borderless">
                                        ...
                                        @if(isset($order->discount_amount) && $order->discount_amount)
                                        <tr>
                                            <td>Discount:</td>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0"><i class="bi bi-credit-card"></i> Payment Information</h5>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
